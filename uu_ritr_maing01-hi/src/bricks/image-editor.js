      ...
      <div className="image-editor-overlay">
        <div className="image-editor-modal">
          <div className="image-editor-header">
            <h2 className="image-editor-title">{lsi.selectTemplate || "Select Diploma Template"}</h2>
            <button onClick={handleClose} className="image-editor-close-btn">
              ✕
            </button>
          </div>
          ...
          <div className="image-editor-templates">
            {DIPLOMA_TEMPLATES.map((template) => (
              ...
              >
                <img src={template.url} alt={template.name} className="image-editor-template-img" />
                <div className="image-editor-template-name">{template.name}</div>
              </div>
            ))}
          </div>
          ...
          <div className="image-editor-upload-section">
            ...
            />
            <button onClick={() => fileInputRef.current?.click()} className="image-editor-upload-btn">
